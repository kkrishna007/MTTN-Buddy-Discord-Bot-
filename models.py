...
biomedWords = ["biomed", "biomedical","biomedical engineering", "BioM", "Bio Medical Engineering"]
...
cseWords = ["CS", "CSE", "Computer Science","Computer Sci", "Computer Science and Engineering"]

dseWords = ["DS", "DSE", "Data Science Engineering", "Data Science"]

eeWords = ["Electrical", "ee", "eee", "Electrical and Electronics Engineering"]

eceWords = ["ece", "ec" "Electronics and Communication Engineering", "Electronics"]

eieWords = ["eie", "instrumentation", "EandI", "E&I","Electronics and Instrumentation Engineering"]

ipWords = ["ip", "industrial", "production","industrial production", "Industrial and Production Engineering"]
